...
public class TC_AP_006 extends BaseTest {
    ...
    public void TestCase6() throws InterruptedException {
        ...
        fillRegisterForm("FNregister", "", "0974000002",
                "MAILregister@mail.com", "UserTestRegis2", "PassTestRegis",
                "PassTestRegis");

        test.info("กรอกข้อมูลไม่ครบ (ขาดนามสกุล)");

        submitAndAssertToast("กรุณากรอกข้อมูลให้ครบทุกช่อง");
    }
